(function(){const l=document.createElement("link").relList;if(l&&l.supports&&l.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))n(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const d of r.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&n(d)}).observe(document,{childList:!0,subtree:!0});function i(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(e){if(e.ep)return;e.ep=!0;const r=i(e);fetch(e.href,r)}})();function c(t){t.addEventListener("click",()=>{const l=document.querySelector("#container"),i=document.querySelector("video");document.querySelector("#video-overlay").classList.toggle("hidden"),l.classList.remove("hidden"),i.play()})}const a=["1.mp4","2.mp4","3.mp4","4.mp4","5.mp4","6.mp4","7.mp4"];function u(t){return`https://pub-f781e2b2eec341c592ca15670ba4ded0.r2.dev/${t}`}function p(t){const l=Math.floor(Math.random()*t.length);return u(t[l])}const f=p(a);document.querySelector("#app").innerHTML=`
...
`;const o=document.getElementById("video-player"),s=document.getElementById("loading-screen");o.addEventListener("loadedmetadata",()=>{s.style.display="none"});o.addEventListener("ended",()=>{o.style.cursor="pointer",o.addEventListener("click",function t(){o.play(),o.style.cursor="default",o.removeEventListener("click",t)})});c(document.querySelector("#play"));o.addEventListener("error",t=>{console.error("Error loading video:",t),s.innerHTML=`
